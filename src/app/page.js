        ...
        {!session ? (
          <div className="w-fit h-50 flex flex-col justify-around items-center p-4 mt-20 bg-black/10 font-stretch-condensed rounded-xl  shadow-2xl text-3xl  font-light  ">
            ...
            <LoginForm
              ...
              style="btn btn-ghost hover:bg-purple-900 transition delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110"
            />
          </div>
        ) : (
          <div className="w-fit h-50 flex flex-col justify-around items-center p-4 mt-20 bg-black/10 font-stretch-condensed rounded-xl  shadow-2xl text-3xl  font-light  ">
            ...
            <button
              className="btn btn-ghost transition delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110"
